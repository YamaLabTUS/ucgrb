...
# -*- coding: utf-8 -*-
"""
GF & LFC (Down) Shadow Price グラフ生成モジュール.

GF&LFC調整力制約（下げ）のシャドウプライスを示すグラフを作成する。
"""
from .._append_col import _append_col
from .._make_shadow_price_chart import _make_shadow_price_chart


def make_gf_lfc_down_sp_graph(ws, period_name, timeline, time_format, m_Pi, uc_data, uc_dicts):
    """
    GF&LFC調整力制約（下げ）のシャドウプライスグラフを作成する.
