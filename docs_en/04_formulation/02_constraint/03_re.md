...
## 1. PV suppression and reserve constraints
...
\\
  ...
  \+ p_{t,a,\text{PV}}^{\text{Tert}\,\text{DOWN}}
   ...
   & \forall t \in T, \forall a \in A
   & \qquad (2\text{-}3\text{-}1\text{-}3)
\end{aligned}
$$

| Condition name                        | Default value | Setting name on the configuration file | Change in the above formula when set to False                                      |
| :------------------------------------ | :------------ | :------------------------------------- | :--------------------------------------------------------------------------------- |
...
## 2. WF suppression and reserve constraints
...
| WF tertiary up-reserve availability   | True          | provide_p_wf_tert_up                   | Fix WF tertiary up-reserve $p_{t,a,\text{WF}}^{\text{Tert}\,\text{UP}}$ to 0       |
